...
{ "categoria": "top|bottom|vestido|abrigo|calzado|accesorio|bolsa|otro",
  "tipo_de_foto": "prenda_sola|puesta",
  ...
  "confianza": 0.0-1.0 }
"tipo_de_foto" describe cómo está fotografiada, no qué prenda es:
- "prenda_sola": la prenda está sola — extendida sobre una superficie, colgada, en un maniquí, o es una foto de catálogo. También cuenta si alguien la sostiene con la mano pero no la trae puesta.
- "puesta": una persona la trae puesta.
Este dato decide cómo se genera la prueba virtual; equivocarlo deforma el resultado. Ante la duda entre las dos, responde "puesta".

Si la imagen no es una prenda (o es contenido inapropiado), devuelve {"error": "motivo"}.` as const;

export const CATALOG_GARMENT_PROMPT_VERSION = 2;
